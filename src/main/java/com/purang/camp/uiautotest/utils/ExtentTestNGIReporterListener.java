...
public class ExtentTestNGIReporterListener implements IReporter {
    ...
    private static final String FILE_NAME = "report-purang" + LocalDate.now() + ".html";
    ...
    private void init() {
        ...
        // 设置点击效果：.node.level-1 ul{ display:none;} .node.level-1.active
        // ul{display:block;}
        ...
        // 设置静态文件的DNS 如果cdn.rawgit.com访问不了，可以设置为：ResourceCDN.EXTENTREPORTS
        // 或者ResourceCDN.GITHUB
