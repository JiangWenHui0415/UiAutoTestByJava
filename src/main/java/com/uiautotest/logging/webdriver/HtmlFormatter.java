...
public class HtmlFormatter {
    private final ReadConfiguration config = new ReadConfiguration("/com/purang/camp/uiautotest/logging/webdriver/logging-style.properties");
    private final ReadConfiguration config_tool = new ReadConfiguration("/com/purang/camp/uiautotest/core/webdriver/webdriver.properties");
