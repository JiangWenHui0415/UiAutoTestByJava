				...
				<div class="r3_counter_box inner-gap">
					...
					<div id="myTabContent" class="tab-content">
						<div class="filter-area gap-below">
							<p>Filter By :
								<form>
									<input type="radio" name="filter" value="group"><i class="fa fa-users"></i>Group</input>
									<input type="radio" name="filter" value="class" checked="checked"><i class="fa fa-book"></i>Test Class</input>
